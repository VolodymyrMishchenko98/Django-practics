...
def get_layout(title, content):
    ...
    <style>
        body { 
        background: lightblue; font-family: sans-serif; padding: 20px; 
        }
        nav { 
        margin-bottom: 20px; background: white; padding: 10px; border-radius: 5px; 
        }
        a { 
        margin-right: 15px; text-decoration: none; color: blue; font-weight: bold; 
        }
        table {
        border-collapse: collapse; background: white; margin-top: 10px; 
        }
        th, td { 
